...
public class MainActivity extends ActionBarActivity implements Communicator{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer_list.setAdapter(new ArrayAdapter<String>(this, R.layout.drawer_list_item, drawer_items));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.action_send_money:
                DialogFragment dialog = dialog_record_money.newInstance();
    ...
    public void refresh(String s){
        ...
        Fragment_List frag = (Fragment_List)fm.findFragmentById(R.id.content_frame);
        frag.Exec();
    }
